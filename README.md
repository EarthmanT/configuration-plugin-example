...
### Blueprint
In order to leverage configration plugin we need two components in a blueprint:
...
-- **params** - represent JSON formatted input of configuration which will be sent to "confguration_loader" type
